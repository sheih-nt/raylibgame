Вот пример оформления второй лекции для **GitHub**, структурированной в Markdown. Этот формат подходит для использования в **README.md** файла внутри папки **Lecture02**:
